...
rows, cols = (2, 4)  # 2 rows, 4 columns for 8 tiles
...
pygame.display.set_caption("Puzzle Game 2024 [Medium Mode]")
...
running = True
background_image = pygame.image.load(backgroundImage)

# Scale the background image to fit the entire window
